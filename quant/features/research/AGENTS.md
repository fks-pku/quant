...
- Formal A-share research defaults to strict backtests from `2016-01-01` through `2026-05-31` with `default_initial_cash=20000`, and reports must include a yearly strategy-return calendar from structured strict Backtester equity results.
