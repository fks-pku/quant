"""2026 Trend-Following Cross-Sectional Momentum

Source: blog (https://snapinnovations.com/best-algo-trading-strategy/)
Authors: Muhammad Ermanja / Snap Innovations; cross-checked with Cube Exchange and Quant Decoded 2026 trend/factor momentum discussions
Type: momentum
Formula: momentum_close_return
Summary: Detected: momentum, breakout
"""
...
@strategy("2026_trend_following_cross_sectional_momentum")
class Strategy2026TrendfollowingCrosssectionalMomentumStrategy(DailyBarStrategy):
    def __init__(
        self,
        ...
        super().__init__("2026_trend_following_cross_sectional_momentum", self._symbols, holding_days=holding_days)
    ...
    def on_start(self, context: "Context") -> None:
        ...
        self.logger = get_logger("Strategy2026TrendfollowingCrosssectionalMomentumStrategy")
