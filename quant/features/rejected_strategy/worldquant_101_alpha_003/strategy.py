...
@strategy("worldquant_101_alpha_003")
class Worldquant101Alpha003Strategy(DailyBarStrategy):
    def __init__(
        self,
        ...
        super().__init__("worldquant_101_alpha_003", self._symbols, holding_days=holding_days)
    ...
    def on_start(self, context: "Context") -> None:
        ...
        self.logger = get_logger("Worldquant101Alpha003Strategy")
