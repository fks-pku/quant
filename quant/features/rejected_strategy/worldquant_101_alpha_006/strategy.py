...
@strategy("worldquant_101_alpha_006")
class Worldquant101Alpha006Strategy(DailyBarStrategy):
    def __init__(
        self,
        ...
        super().__init__("worldquant_101_alpha_006", self._symbols, holding_days=holding_days)
    ...
    def on_start(self, context: "Context") -> None:
        ...
        self.logger = get_logger("Worldquant101Alpha006Strategy")
