...
Source: joinquant_community (https://www.joinquant.com/community/post/detailMobile?postId=59884)
Authors: Codex Quant Research
Type: factor
Formula: joinquant_small_cap_low_price_factor
...
class JoinquantSmallCapLowPriceStrategy(DailyBarStrategy):
    def __init__(
        self,
        ...
        super().__init__("joinquant_small_cap_low_price", self._symbols, holding_days=holding_days)
    ...
    def on_start(self, context: "Context") -> None:
        ...
        self.logger = get_logger("JoinquantSmallCapLowPriceStrategy")
