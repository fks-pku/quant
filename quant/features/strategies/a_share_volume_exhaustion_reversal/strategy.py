"""A-Share Volume Exhaustion Reversal

Source: ashare_structural (https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3810114)
Authors: Codex Quant Research
Type: mean_reversion
Formula: ashare_volume_exhaustion_reversal
...
@strategy("a_share_volume_exhaustion_reversal")
class AshareVolumeExhaustionReversalStrategy(DailyBarStrategy):
    def __init__(
        self,
        ...
        super().__init__("a_share_volume_exhaustion_reversal", self._symbols, holding_days=holding_days)
    ...
    def on_start(self, context: "Context") -> None:
        ...
        self.logger = get_logger("AshareVolumeExhaustionReversalStrategy")
