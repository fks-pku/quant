...
Type: momentum
Formula: ashare_low_volatility_momentum
...
@strategy("a_share_low_volatility_momentum")
class AshareLowVolatilityMomentumStrategy(DailyBarStrategy):
    def __init__(
        self,
        ...
        super().__init__("a_share_low_volatility_momentum", self._symbols, holding_days=holding_days)
    ...
    def on_start(self, context: "Context") -> None:
        ...
        self.logger = get_logger("AshareLowVolatilityMomentumStrategy")
