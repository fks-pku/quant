"""BigQuant 行业轮动：景气度、趋势与拥挤度

Source: bigquant (https://bigquant.com/square/paper/a7300085-2b6e-46dc-a0bd-0a56bd11ff58)
Authors: BigQuant AI Quant
Type: unknown
Formula: ashare_industry_prosperity_trend_crowding_rotation
Summary: unknown idea triaged by deterministic professional rubric
"""
...
@strategy("bigquant_7c7b0ea0")
class BigquantStrategy(DailyBarStrategy):
    def __init__(
        self,
        ...
        super().__init__("bigquant_7c7b0ea0", self._symbols, holding_days=holding_days)
    ...
    def on_start(self, context: "Context") -> None:
        ...
        self.logger = get_logger("BigquantStrategy")
    ...
    def _signal_scores(self) -> Dict[str, float]:
        ...
        if frame.empty:
            ...
            return {}
        signal = compute_signal("ashare_industry_prosperity_trend_crowding_rotation", frame, self.lookback)
