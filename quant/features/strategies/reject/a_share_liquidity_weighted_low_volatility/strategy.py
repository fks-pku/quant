"""A-Share Liquidity-Weighted Low Volatility

Source: ashare_structural (local://ashare_structural_daily_ideas)
Authors: Codex Quant Research
Type: factor
Formula: ashare_liquidity_weighted_low_volatility
Summary: factor idea triaged by deterministic professional rubric
"""
...
@strategy("a_share_liquidity_weighted_low_volatility")
class AshareLiquidityweightedLowVolatilityStrategy(DailyBarStrategy):
    def __init__(
        self,
        ...
        super().__init__("a_share_liquidity_weighted_low_volatility", self._symbols, holding_days=holding_days)
    ...
    def on_start(self, context: "Context") -> None:
        ...
        self.logger = get_logger("AshareLiquidityweightedLowVolatilityStrategy")
