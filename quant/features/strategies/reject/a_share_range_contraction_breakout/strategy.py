"""A-Share Range Contraction Breakout

Source: ashare_structural (local://ashare_structural_daily_ideas)
Authors: Codex Quant Research
Type: momentum
Formula: ashare_range_contraction_breakout
Summary: momentum idea triaged by deterministic professional rubric
"""
...
@strategy("a_share_range_contraction_breakout")
class AshareRangeContractionBreakoutStrategy(DailyBarStrategy):
    def __init__(
        self,
        ...
        super().__init__("a_share_range_contraction_breakout", self._symbols, holding_days=holding_days)
    ...
    def on_start(self, context: "Context") -> None:
        ...
        self.logger = get_logger("AshareRangeContractionBreakoutStrategy")
