...
@strategy("a_share_volatility_scaled_reversal")
class AshareVolatilityscaledReversalStrategy(DailyBarStrategy):
    def __init__(
        self,
        ...
        super().__init__("a_share_volatility_scaled_reversal", self._symbols, holding_days=holding_days)
    ...
    def on_start(self, context: "Context") -> None:
        ...
        self.logger = get_logger("AshareVolatilityscaledReversalStrategy")
