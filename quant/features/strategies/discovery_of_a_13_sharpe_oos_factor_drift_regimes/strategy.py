...
Source: arxiv (http://arxiv.org/abs/2511.12490v1)
...
@strategy("discovery_of_a_13_sharpe_oos_factor_drift_regimes")
class DiscoveryOfA13sharpeOosFactorDriftRegimesUnlockHiddenCrosssectionalPredictabilityStrategy(DailyBarStrategy):
    def __init__(
        self,
        ...
        super().__init__("discovery_of_a_13_sharpe_oos_factor_drift_regimes", self._symbols, holding_days=holding_days)
    ...
    def on_start(self, context: "Context") -> None:
        ...
        self.logger = get_logger("DiscoveryOfA13sharpeOosFactorDriftRegimesUnlockHiddenCrosssectionalPredictabilityStrategy")
