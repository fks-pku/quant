...
Source: ssrn (https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6371558)
...
@strategy("systematic_reversal_hedged_industry_momentum")
class SystematicReversalHedgedIndustryMomentumStrategy(DailyBarStrategy):
    def __init__(
        self,
        ...
        super().__init__("systematic_reversal_hedged_industry_momentum", self._symbols, holding_days=holding_days)
    ...
    def on_start(self, context: "Context") -> None:
        ...
        self.logger = get_logger("SystematicReversalHedgedIndustryMomentumStrategy")
