...
class BollingerMeanReversion(DailyBarStrategy):
    ...
    def __init__(
        ...
        super().__init__("BollingerMeanReversion", self._symbols, holding_days=1)
        self.holding_days = holding_days

    @property
    def _max_keep_hint(self) -> int:
        return max(self.bb_lookback, self.rsi_period + 1, self.atr_period + 1) * 2
