...
class RegimeFilteredMomentum(DailyBarStrategy):
    ...
    def __init__(
        ...
        super().__init__("RegimeFilteredMomentum",
                         list(set(_trading_syms + [benchmark_symbol])),
                         holding_days)
    ...
    def _max_keep_hint(self) -> int:
        return max(self.momentum_lookback, self.vol_lookback) * 2 + 10
