...
Usage:
    python quant/scripts/ingest_akshare.py --symbol 600519 --start 2023-01-01 --end 2024-01-01
"""
...
def main() -> None:
    ...
    parser.add_argument("--symbol", required=True, help="A-share symbol, e.g. 600519")
    ...
    rows_saved = storage.save_bars(df, timeframe="1d")

    logger.info(f"Saved {rows_saved} rows to DuckDB")
    storage.close()
